...
const Home = ({ data }) => {
  ...
  return (
    <>
      <Head>
        <title>
          Affordable Family Dentist in Bayswater | Bayswater Dentist
        </title>
        <meta
          name="description"
          content="Looking for family dental clinic in Bayswater. Bayswater Dentist offers personalised and professional dental care from a highly experienced dentist. Visit today!"
        />
        ...
        <>
          <main>
            ...
            <section
              ...
              className="mt-md-5 mt-3 py-md-3 py-4 bg-light"
            >
              <Offer />
            </section>
            <section
              style={{ overflowX: "hidden" }}
              className="mt-md-2 mt-3 py-md-3 py-4"
            >
              <PaymentOpt />
            </section>
            <section
