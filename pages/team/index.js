  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Meet our team of highly experienced dentists who have been practicing their skills for years and have been providing their patients an excellent results."
        />
              ...
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={5}>
                  <PageSectionalHeading
                    ...
                    align="center"
                  />
                  <Typography className="para" style={{ fontSize: "1.2rem" }}>
                      ...
                      {[
...

                        {
                          ...
                          para: [
                            ...
                            "A strong believer of quality based dentistry. From the time a patient arrives she works on putting patients at ease and makes them comfortable during their visits and works on bringing their confident smile. She works on gaining knowledge through continuing professional development programs.",
                            "Apart from dentistry, she spends most of the time with her family and young kids. She enjoys listening to music, cooking, exploring new walking trails, watching sunrise and cycling.",
...

                        {
                          ...
                          para: [
                            ...
                            "Outside of dentistry, she leads an active lifestyle, keeping fit with running and boot camping and also enjoys baking, watching Netflix and spending time with her family.",
                          ],
                        },
                      ].map((item) => (
